...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($editing) {
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            echo '<script>alert("Assessment added successfully"); window.location.href = "/EDG/EDG/HTML/Admin_Assessments.php";</script>';
        } else {
            echo "Error: " . $sql . "<br>" . $conn->error;
        }
    }
...
<head>
    ...
    <title><?php echo $editing ? 'Edit Assessment' : 'Add New Assessment'; ?></title>
    <link rel="stylesheet" href="/EDG/EDG/PHP/Add_Assessment.php" />
    <style>
        body {
...
<main>
    <div class="form-container">
        <h1><?php echo $editing ? 'Edit Assessment' : 'Add New Assessment'; ?></h1>
        <form action="Add_Assessment.php" method="POST">
            ...
            <div class="button-group">
                <button type="submit"><?php echo $editing ? 'Update' : 'Add'; ?> Assessment</button>
