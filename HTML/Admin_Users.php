    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a href="../HTML/Admin_Assessments.php" class="nav-link">
          ...
          <span class="link-text">Manage Assessments</span>
        </a>
      </li>

      <li class="nav-item">
        <a href="../HTML/Admin_Materials.php" class="nav-link">
    ...
    <div class="table-container">
      <table>
        ...
        <?php
          ...
          $sql = "SELECT User_id, FirstName, LastName, DOB, Gender, PhoneNumber, Email, Role FROM users";
