...
$sql = "SELECT q.Quiz_id, q.User_id, q.Score, 
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a href="../HTML/Admin_Users.php" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 650 520" fill="white">
        ...
        <table>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>" . htmlspecialchars($row["Parent_name"] . " - " . $row["Category_Name"]) . "</td>";
